...
if "18.00." in CL_STDERR:
    ...
    import sys
    print(f"Visual C version not supported {CL_STDERR}\n")
    sys.exit(1)
...
BF_QUICKTIME = f'{LIBDIR}/QTDevWin'
...
if VC_VERSION == '12.0':
    CCFLAGS.extend(('/D_WIN32_WINNT=0x600', '/DOIIO_STATIC_BUILD'))
CXXFLAGS = ['/EHsc']
